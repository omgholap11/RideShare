...
const LogInOptions = () => {
  ...
  const navigateToUserLogIn = ()=>{
    navigate("/userlogin" , {state : {from : 'loginoptions' }});
  }
...
return (
  // Outer div: Sets background, min-height, top padding, and horizontal padding.
  // Removed 'flex' and 'justify-center' from here.
        ...
        <div className="w-full md:w-1/2 p-12 flex flex-col justify-center">
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <span className="text-lg font-semibold">Log In as Passenger</span>
            </button>
