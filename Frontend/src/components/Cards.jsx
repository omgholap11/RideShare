...
function Cards(){
    return (
      <>
        <div className="relative min-h-screen py-16 bg-indigo-100 font-sans overflow-hidden">
      ...
      <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Card 1 */}
            <div className="bg-blue-50 p-6 rounded-lg shadow-2xl transition-all duration-300 transform hover:-translate-y-4">
            ...
            {/* Card 2 */}
            <div className="bg-green-50  p-6 rounded-lg shadow-2xl transition-all duration-300 transform hover:-translate-y-4">
            ...
            {/* Card 3 */}
            <div className="bg-purple-50  p-6 rounded-lg shadow-2xl transition-all duration-300 transform hover:-translate-y-4">
            ...
            {/* Card 4 */}
            <div className="bg-red-50 p-6 rounded-lg shadow-2xl transition-all duration-300 transform hover:-translate-y-4">
            ...
            {/* Card 5 */}
            <div className="bg-yellow-50  p-6 rounded-lg shadow-2xl transition-all duration-300 transform hover:-translate-y-4">
            ...
            <div className="bg-indigo-50  p-6 rounded-lg shadow-2xl transition-all duration-300 transform hover:-translate-y-4">
      ...
      <CounterCards/>
      <RideshareFaq/>
      <section className="relative pb-12 bg-indigo-100">
        <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 w-96 h-96 bg-gradient-to-br from-indigo-300/20 to-purple-300/20 rounded-full blur-3xl"></div>
        <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-gradient-to-tr from-blue-300/20 to-cyan-300/20 rounded-full blur-3xl"></div>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-72 h-72 bg-gradient-to-r from-violet-300/10 to-pink-300/10 rounded-full blur-3xl"></div>
      ...
      <div className="text-center">
          ...
          <div className="flex justify-center space-x-8">
            <a href="#" className="bg-gradient-to-r from-indigo-500 to-purple-500 hover:bg-gray-300 p-3 rounded-full transition duration-300">
